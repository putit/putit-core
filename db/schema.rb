...
ActiveRecord::Schema.define(version: 20_190_929_194_210) do
  ...
  create_table 'approvals', force: :cascade do |t|
    ...
    t.index %w[user_id release_order_id], name: 'index_approvals_on_user_id_and_release_order_id', unique: true
  ...
  create_table 'deployment_pipeline_steps', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'position'
    t.index %w[deployment_pipeline_id step_id], name: 'step_pipeline_index', unique: true
  ...
  create_table 'envs', force: :cascade do |t|
    ...
    t.index %w[name application_id], name: 'index_envs_on_name_and_application_id', unique: true
  end
  ...
  create_table 'hosts', force: :cascade do |t|
    ...
    t.index %w[fqdn env_id], name: 'index_hosts_on_fqdn_and_env_id', unique: true
  end
  ...
  create_table 'paper_trail_versions', force: :cascade do |t|
    ...
    t.index %w[item_type item_id], name: 'index_paper_trail_versions_on_item_type_and_item_id'
  end
  ...
  create_table 'physical_files', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[fileable_type fileable_id], name: 'index_physical_files_on_fileable_type_and_fileable_id'
  end
  ...
  create_table 'release_order_results', force: :cascade do |t|
    ...
    t.index %w[release_order_id env_id application_id], name: 'uniq_result', unique: true
  ...
  create_table 'subreleases', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[release_id subrelease_id], name: 'index_subreleases_on_release_id_and_subrelease_id', unique: true
